    ...
    <div>
      ...
      <div className="mt-6 flex flex-col gap-3">
        {(testimonials ?? []).map((t) => (
          <div key={t.id} className="rounded-lg border border-neutral-200 p-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm italic text-neutral-700">&ldquo;{t.quote}&rdquo;</p>
              ...
              <form action={toggleTestimonialPublished}>
                ...
                <button type="submit" className="whitespace-nowrap text-xs text-blue-700 underline">
        ...
        {(testimonials ?? []).length === 0 && (
          <p className="py-6 text-center text-sm text-neutral-400">No testimonials yet.</p>
        )}
      </div>
    </div>
  );
