...
export function TutorWidget() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-6 z-30 flex h-[28rem] flex-col rounded-lg border border-line bg-surface-raised shadow-xl sm:inset-x-auto sm:right-6 sm:w-80">
